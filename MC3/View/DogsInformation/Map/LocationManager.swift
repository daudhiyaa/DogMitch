...
class LocationManager: NSObject,ObservableObject,MKMapViewDelegate, CLLocationManagerDelegate{
    ...
    // MARK: Final Location
    @Published var dogLocation: CLLocation?
    @Published var dogPlaceMark: CLPlacemark?
    
    override init() {
        super.init()
        // MARK: Setting Deledates
    ...
    func addDraggablePin(coordinate: CLLocationCoordinate2D){
        ...
        annotation.title = "Your Dog's Location"
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        let marker = MKMarkerAnnotationView(annotation: annotation, reuseIdentifier: "DOGPIN")
    ...
    func mapView(_ mapView: MKMapView, annotationView view: MKAnnotationView, didChange newState: MKAnnotationView.DragState, fromOldState oldState: MKAnnotationView.DragState) {
        ...
        self.dogLocation = .init(latitude: newLocation.latitude, longitude: newLocation.longitude)
